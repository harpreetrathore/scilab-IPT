...
toolbox_title = "Skeleton_imageprocessing";
...
C_Flags=["-w -fpermissive -I"+tools_path+"include/opencv -I"+tools_path+"include/ -Wl,-rpath="+tools_path+"lib/"+Version+filesep()+" "]

Linker_Flag = ["-L"+tools_path+"lib/"+Version+"-lopencv_shape -lopencv_stitching -lopencv_objdetect -lopencv_superres -lopencv_videostab -lopencv_calib3d -lopencv_features2d -lopencv_highgui -lopencv_videoio -lopencv_imgcodecs -lopencv_video -lopencv_photo -lopencv_ml -lopencv_imgproc -lopencv_flann -lopencv_core "]
...
tbx_build_gateway(toolbox_title, ..
	names, ..
    files, ..
    get_absolute_file_path("builder_gateway_cpp.sce"),[],Linker_Flag, C_Flags);
endfunction
